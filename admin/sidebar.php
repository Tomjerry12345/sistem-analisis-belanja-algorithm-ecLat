<div class="sidebar">
    <p class="text-center text-white pt-3">Panel Administrator</p>
    <a class="<?php echo $menu1; ?>" href="dashboard.php"><i class="fa fa-home"></i><span>Home</span></a>
    <a class="<?php echo $menu7; ?>" href="upload.php"><i class="fa fa-cloud-upload"></i><span>Upload Data</span></a>
...
<button class="btn btn-default menu-toggle" onclick="toggleMenu()">
